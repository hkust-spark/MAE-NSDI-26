...
struct RobustThroughputEstimatorSettings {
  ...
  unsigned window_packets = 10;
  unsigned max_window_packets = 20;
  TimeDelta min_window_duration = TimeDelta::Millis(60);
  TimeDelta max_window_duration = TimeDelta::Millis(60);
